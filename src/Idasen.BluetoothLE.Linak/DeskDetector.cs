    ...
    : IDeskDetector
{
    ...
    /// <inheritdoc />
    public IDeskDetector Initialize(
        string deviceName,
        ulong deviceAddress,
        uint deviceTimeout)
    {
    ...
    /// <inheritdoc />
    public void StopListening() => _monitor.StopListening();
    ...
    {
        _logger.Information(
            "[{Mac}] Device Name Changed: {Details}",
            device.MacAddress,
            device.Details);
    }
