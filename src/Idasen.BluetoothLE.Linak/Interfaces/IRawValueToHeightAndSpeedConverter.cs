...
public interface IRawValueToHeightAndSpeedConverter
{
    ...
    /// <param name="height">When this method returns, contains the parsed height (in device units) if the conversion succeeded; otherwise 0.</param>
    /// <param name="speed">When this method returns, contains the parsed speed (in device units) if the conversion succeeded; otherwise 0.</param>
    /// <returns>
