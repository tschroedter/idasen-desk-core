    ...
    : IHasReachedTargetHeightCalculator
{
    ...
    public IHasReachedTargetHeightCalculator Calculate()
    {
        ...
        _logger.Debug(
            "ReachedCalc Target={TargetHeight} StopListening={StoppingHeight} Move={MoveIntoDirection} StartListening={StartMovingIntoDirection} Delta={Delta} UntilStop={MovementUntilStop} Reached={HasReachedTargetHeight}",
            TargetHeight,
            StoppingHeight,
            MoveIntoDirection,
